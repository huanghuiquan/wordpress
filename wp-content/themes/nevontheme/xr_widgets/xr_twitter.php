 ...
 */
class XR_Twitter_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
	 		'xr_twitter_widget', // Base ID
			'XR Twitter Widget', // Name
			array( 'description' => __( 'XR Twitter Widget', 'text_domain' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$use_dark = checked('1', $instance['use_dark']) ? 'data-theme="dark"' : 'data-theme="light"';
	...
	public function form( $instance ) {
        ...
        <p>
		<label for="<?php echo $this->get_field_id( 'total' ); ?>"><?php _e( 'Total Tweets:' ); ?></label> 
		...
		<label for="<?php echo $this->get_field_id( 'use_dark' ); ?>"><?php _e( ' Check this for dark layout' ); ?></label> 
        </p>
		<?php 
	}
...
add_action( 'widgets_init', create_function( '', 'register_widget( "xr_twitter_widget" );' ) );
