...
if(is_category()){
	if(is_day()){
		echo do_shortcode("[headerText header='".get_the_time('F').' '.get_the_time('d').' '.get_the_time('Y')."']"); 
	}elseif(is_month()){
		echo do_shortcode("[headerText header='".get_the_time('F').' '.get_the_time('Y')."']"); 
	}elseif(is_year()){
		echo do_shortcode("[headerText header='".get_the_time('Y')."']"); 
	}else{
		echo do_shortcode("[headerText header='".single_cat_title("",false)."']"); 
	}
}elseif(is_archive()){
	if(is_day()){
		echo do_shortcode("[headerText header='".get_the_time('F').' '.get_the_time('d').' '.get_the_time('Y')."']"); 
	...
	echo do_shortcode("[headerText header='".get_the_title()."']"); 
}
?>
<div id="blog-pages">
<?php 
...
">
	...
	$title = get_the_title();
	//wp_reset_query();
	//$homeproducts = new WP_Query( array('category_name' => $title,'paged' => ( get_query_var('paged') ? get_query_var('paged') : 1 )));
