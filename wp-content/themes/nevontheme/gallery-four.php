<?php
/*
Template Name: Gallery Four Column
*/
?>
...
<div id="filtered-gallery">   
    <ul class="gallery-grid four-col-gallery">
        ...
        $pfportfolio = new WP_Query( array('post_type'=> 'filteredgallery', 'posts_per_page' => ot_get_option('gallery-filtered-four-total',8)));
...
jQuery(window).load(function(){
	...
	var changeHeight = parseInt(58  + (Math.ceil(totalLi/ 4) * 200));
