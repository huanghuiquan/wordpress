...
<div id="filtered-gallery" class="">   
    <ul class="gallery-grid two-col-gallery">
        <?php
				
        $pfportfolio = new WP_Query( array('post_type'=> 'filteredgallery', 'posts_per_page' => ot_get_option('gallery-filtered-three-total',9)));
		...
		foreach(split(" ", $terms_as_text) as $singleTerm){
            ...
            echo '<li class="three-column three-column-img" data-id="post-'.get_the_ID().'" data-type="'.$terms_as_text.'"';
			...
			echo '<div class="gallery-view three-column-img">';
            the_post_thumbnail('gallery-three', array("alt" => get_the_title() ));
			echo '<a href="';
...
jQuery(window).load(function(){
	...
	var changeHeight = parseInt(58  + (Math.ceil(totalLi/ 3) * 260));
