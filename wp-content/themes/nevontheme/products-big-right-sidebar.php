<?php
/*
Template Name: Products Big Right Sidebar
*/
?>
...
">
	...
	if ($homeproducts->have_posts()) : while ($homeproducts->have_posts()) : $homeproducts->the_post(); 
        ...
        <div class="products-holder">
				...
				echo '</div>';
				?>
            <div class="details-area details-area-reg-class <?php if($sidebar === 'full-width') {echo 'width-three';}else{echo 'width-full';} ?>">
            	<div class="details-area-in details-area-in-reg-class" >
                <?php 
