<?php
/*
Template Name: Products Big Full Width
*/
?>
...
">
	...
	if ($homeproducts->have_posts()) : while ($homeproducts->have_posts()) : $homeproducts->the_post(); 
        ...
        <div class="products-holder">
				...
				echo '</div>';
				?>
            <div class="details-area details-area-class <?php if($sidebar === 'full-width') {echo 'width-three';}else{echo 'width-full';} ?>">
