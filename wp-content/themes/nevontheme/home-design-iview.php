<?php
/*
Template Name: Home iView Slider
*/
?>
<?php 
...
wp_enqueue_style('iview-style', F_WAY.'/css/iview.css');
}    
...
<div class="container">
    ...
    <?php echo do_shortcode('[headerText header="'.__('Our Latest Projects').'"]'); ?>
...
<?php echo do_shortcode('[headerText header="'.__('Why Us?').'"]'); ?>
...
?>
    ...
    <div class="nevon-basic-slider right margin-right-zero">
    	<div class="small-h1"><?php _e(ot_get_option("home_testimonial_text")); ?></div>
