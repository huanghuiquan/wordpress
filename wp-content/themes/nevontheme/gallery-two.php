...
<div id="filtered-gallery">   
    <ul class="gallery-grid">
        ...
        $pfportfolio = new WP_Query( array('post_type'=> 'filteredgallery', 'posts_per_page' => ot_get_option('gallery-filtered-two-total',6)));
		...
		foreach(split(" ", $terms_as_text) as $singleTerm){
            ...
            echo '<li class="two-column two-column-img" data-id="post-'.get_the_ID().'" data-type="'.$terms_as_text.'"';
...
jQuery(window).load(function(){
	...
	var changeHeight = parseInt(58  + (Math.ceil(totalLi/ 2) * 380));
