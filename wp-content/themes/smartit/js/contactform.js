jQuery(document).ready(function() {
    ...
    jQuery("#contactform").submit(function(){
        ...
        jQuery.post(ajaxurl, data, function(response) {
            ...
            if(response.is_errors){
                jQuery("#contact_form_responce ul").addClass("contact_form_responce_error error");
                ...
                jQuery("#contact_form_responce ul").addClass("contact_form_responce_succsess success");
	...
	jQuery(".contact-form textarea").each(function(){
		jQuery(this).parents('.input-block').removeClass().addClass("textarea-block");
	});
