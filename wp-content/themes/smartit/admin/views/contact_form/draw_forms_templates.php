    ...
    <div class="form-holder">
        ...
        <div class="switch">
            <label><input type="checkbox" class="form_captcha option_checkbox" />
                <input type="hidden" name="contact_form[__INIQUE_ID__][has_capture]" value="0" /><?php _e('Enable Captcha Protection', THEMEMAKERS_THEME_FOLDER_NAME); ?></label>
        ...
        <div class="admin-drag-holder clearfix">
            ...
            <div class="contact_form_submit_button">
                ...
                <select name="contact_form[__INIQUE_ID__][submit_button]" style="display: none;">
