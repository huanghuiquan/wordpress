        ...
        <tr>
            <th style="width:25%">
                <label for="portfolio_date">
                    <strong><?php _e('Release Date', THEMEMAKERS_THEME_FOLDER_NAME); ?></strong>
        ...
        <tr style="border-top:1px solid #eeeeee;">
            <th style="width:25%">
                <label for="portfolio_url">
                    <strong><?php _e('Project URL', THEMEMAKERS_THEME_FOLDER_NAME); ?></strong>
                    <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;"><?php _e('For example', THEMEMAKERS_THEME_FOLDER_NAME); ?> http://demolink.org</span>
                </label>
            </th>
            <td>
        ...
        <tr style="border-top:1px solid #eeeeee;">
            <th style="width:25%">
                <label for="portfolio_url_title">
                    <strong><?php _e('URL Title', THEMEMAKERS_THEME_FOLDER_NAME); ?></strong>
                    <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;"></span>
                </label>
            </th>
            <td>
        ...
        <tr style="border-top:1px solid #eeeeee;">
            <th style="width:25%">
                <label for="portfolio_tools">
                    <strong><?php _e('Tools', THEMEMAKERS_THEME_FOLDER_NAME); ?></strong>
                    <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;"><?php _e('Tools used to create this portfolio.', THEMEMAKERS_THEME_FOLDER_NAME); ?></span>
                </label>
            </th>
            <td>
                ...
                <th style="width:25%">
                    <label for="thememakers_portfolio">
                        ...
                        <span style=" display:block; color:#999; margin:5px 0 0 0; line-height: 18px;">
                            <?php _e('Add or remove media fields.', THEMEMAKERS_THEME_FOLDER_NAME); ?>
                        </span>
                    </label>
                </th>
                <td>
