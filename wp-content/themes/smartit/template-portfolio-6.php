...
$posts_per_page = get_option(THEMEMAKERS_THEME_PREFIX . 'porfolio_6col_posts_per_page');
if (!$posts_per_page) {
    $posts_per_page = 12;
}
...
if (!$_REQUEST['porfolio_6col_excerpt_symbols_count']) {
    $_REQUEST['porfolio_6col_excerpt_symbols_count'] = 80;
}
...
<?php get_template_part('content', 'portfolio_6'); ?>
